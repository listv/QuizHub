...
export class ApiService {
    ...
    restoreTest(id: string): Observable<any> {
        return this.http.post(`${this.url}/tests/${id}/restore`, {});
    }

    duplicateTest(id: string): Observable<any> {
        return this.http.post(`${this.url}/tests/${id}/duplicate`, {});
    }
